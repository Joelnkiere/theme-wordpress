	...
	<div class="site-header__inner">
		...
		<nav class="primary-navigation" id="primary-menu" aria-label="<?php esc_attr_e( 'Primary navigation', 'amcham-drc' ); ?>" data-primary-nav>
			<div class="primary-navigation__inner">
				...
				?>
				<a href="<?php echo esc_url( home_url( '/become-a-member/' ) ); ?>" class="nav-cta-link button button--red" style="min-height: 40px; padding: 0 16px; font-size: 11px; flex-shrink: 0; margin-bottom: 0;">
