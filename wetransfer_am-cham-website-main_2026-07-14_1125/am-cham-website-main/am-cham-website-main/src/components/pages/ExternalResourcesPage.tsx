...
export default function ExternalResourcesPage() {
  ...
  const loadResources = async () => {
    try {
      ...
      const externalResources = result.items.filter(r => 
        externalAuthors.some(author => r.authorSource?.toLowerCase().includes(author))
      );
      setResources(prev => skip === 0 ? externalResources : [...prev, ...externalResources]);
        ...
        <div className="container mx-auto px-4 relative z-10">
          <AnimatedElement>
            <div className="max-w-4xl mx-auto text-center">
              <p className="font-paragraph text-primary text-sm uppercase tracking-wide mb-4">External Resources</p>
              ...
              <p className="font-paragraph text-primary/90 text-lg leading-relaxed">
                In-depth analysis and insights from external sources on key business topics.
              </p>
            </div>
          </AnimatedElement>
        </div>
            ...
            <AnimatedElement>
              <div className="text-center mb-12">
                ...
                <p className="font-paragraph text-muted-foreground text-lg max-w-3xl mx-auto">
                  Access our collection of external analysis and business insights.
                </p>
              </div>
            </AnimatedElement>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center">
              ...
              <p className="font-paragraph text-muted-foreground text-lg mb-8">
                Check back soon for new external resources.
              </p>
          ...
          <AnimatedElement>
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="font-paragraph text-primary/90 text-lg mb-8 leading-relaxed">
                Members receive exclusive access to premium analysis and external resources.
              </p>
              <Button 
                asChild
                size="lg"
