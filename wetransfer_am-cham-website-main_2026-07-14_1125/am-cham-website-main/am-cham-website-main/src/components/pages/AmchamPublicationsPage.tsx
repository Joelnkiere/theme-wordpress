...
export default function AmchamPublicationsPage() {
  ...
  const loadResources = async () => {
    try {
      ...
      const amchamPublications = result.items.filter(r => r.authorSource?.toLowerCase().includes('amcham drc research team'));
      setResources(prev => skip === 0 ? amchamPublications : [...prev, ...amchamPublications]);
        ...
        <div className="container mx-auto px-4 relative z-10">
          <AnimatedElement>
            <div className="max-w-4xl mx-auto text-center">
              <p className="font-paragraph text-primary text-sm uppercase tracking-wide mb-4">Research & Publications</p>
              ...
              <p className="font-paragraph text-primary/90 text-lg leading-relaxed">
                Documents and papers produced by the AmCham DRC Research Team providing insights into the DRC business environment.
              </p>
            </div>
          </AnimatedElement>
        </div>
            ...
            <AnimatedElement>
              <div className="text-center mb-12">
                ...
                <p className="font-paragraph text-muted-foreground text-lg max-w-3xl mx-auto">
                  Access our comprehensive collection of research publications and reports.
                </p>
              </div>
            </AnimatedElement>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center">
              ...
              <p className="font-paragraph text-muted-foreground text-lg mb-8">
                Check back soon for new AmCham publications.
              </p>
          ...
          <AnimatedElement>
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="font-paragraph text-primary/90 text-lg mb-8 leading-relaxed">
                Members receive exclusive access to premium publications and research reports.
              </p>
              <Button 
                asChild
                size="lg"
