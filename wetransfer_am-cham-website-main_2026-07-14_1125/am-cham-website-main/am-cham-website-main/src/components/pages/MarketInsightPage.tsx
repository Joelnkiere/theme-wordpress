...
export default function MarketInsightPage() {
  ...
  const loadResources = async () => {
    try {
      ...
      const marketReports = result.items.filter(r => r.category?.toLowerCase() === 'market report');
      setResources(prev => skip === 0 ? marketReports : [...prev, ...marketReports]);
  ...
  // Separate US and DRC market reports
  const usMarketReports = resources.filter(r => r.title?.toLowerCase().includes('us') || r.description?.toLowerCase().includes('us market'));
  const drcMarketReports = resources.filter(r => !usMarketReports.includes(r));
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <AnimatedElement>
            <div className="max-w-4xl mx-auto text-center">
              <p className="font-paragraph text-primary text-sm uppercase tracking-wide mb-4">Market Intelligence</p>
              ...
              <p className="font-paragraph text-primary/90 text-lg leading-relaxed">
                Comprehensive market reports and analysis for US and DRC markets to inform your strategic decisions.
              </p>
            </div>
          </AnimatedElement>
        </div>
      ...
      {/* US Market Reports Section */}
      {usMarketReports.length > 0 && (
            ...
            <AnimatedElement>
              <div className="text-center mb-12">
                ...
                <p className="font-paragraph text-muted-foreground text-lg max-w-3xl mx-auto">
                  In-depth analysis of US market trends and opportunities.
                </p>
              </div>
            </AnimatedElement>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
              {usMarketReports.map((resource, index) => (
      ...
      {/* DRC Market Reports Section */}
      {drcMarketReports.length > 0 && (
          ...
          <div className="container mx-auto px-4">
            <AnimatedElement>
              <div className="text-center mb-12">
                ...
                <p className="font-paragraph text-muted-foreground text-lg max-w-3xl mx-auto">
                  Comprehensive analysis of DRC market dynamics and business opportunities.
                </p>
              </div>
            </AnimatedElement>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
              {drcMarketReports.map((resource, index) => (
                <AnimatedElement key={resource._id} delay={index * 50}>
                  <Card className="bg-card border-border hover:shadow-xl transition-all hover:scale-[1.02] overflow-hidden h-full group">
                    {resource.thumbnail && (
                      <div className="overflow-hidden">
          ...
          <div className="container mx-auto px-4">
            <div className="text-center">
              ...
              <p className="font-paragraph text-muted-foreground text-lg mb-8">
                Check back soon for new market intelligence reports.
              </p>
          ...
          <AnimatedElement>
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="font-paragraph text-primary/90 text-lg mb-8 leading-relaxed">
                Members receive exclusive access to premium reports and personalized market intelligence.
              </p>
              <Button 
                asChild
                size="lg"
